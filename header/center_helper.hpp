#ifndef CENTER_HELPER_HPP
#define CENTER_HELPER_HPP

#include <string>
#include <iostream>
#include <iomanip>

// helper class that allows for the centering of iomanip strings that use setw()
// acts like a kind of "std::center" for setw() in the same way as "std::left" or "std::right"
